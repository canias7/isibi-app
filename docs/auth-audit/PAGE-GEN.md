...
- output 10,338 tok/sample · fresh in 4,046 · cache read 32,298 · write 16,149
- $0.2375 a sample at list price · comments are 0.0% of the source written

## Samples

- **booking 1. ok** — index.tsx, book.tsx, manage.tsx, work.tsx, notes.tsx, account.tsx
- **menu 1. ok** — index.tsx
- **tool 1. ok** — index.tsx, records.tsx, record.tsx, playbook.tsx