...
type Booking = Row & { class_name: string };
...
const SLOTS = ["07:00", "09:00", "10:00", "12:00", "17:30", "18:00", "19:30"];
      ...
      <SiteChrome {...CHROME}>
        <div className="mx-auto max-w-lg px-6 py-20 text-center motion-enter">
          ...
          <p className="mt-3 text-muted-foreground">
            We've saved your spot. See you in the studio.
          </p>
          <Button asChild className="mt-6">
            <Link to="/timetable">Back to the timetable</Link>
          </Button>
        </div>
      </SiteChrome>
    );
  ...
  return (
    <SiteChrome {...CHROME}>
      <div className="mx-auto max-w-2xl px-6 py-14">
        ...
        <p className="mt-2 text-muted-foreground">Reserve your spot — no account needed.</p>
