    ...
    <SiteChrome {...CHROME}>
      <div className="mx-auto max-w-lg px-6 py-16">
        ...
        <p className="mt-4 text-muted-foreground">
          Bookings here are confirmed by email, but there isn't yet a way to look one up or change it from this
          page. If you need to move or cancel a class, drop us an email or call the studio and we'll sort it
          straight away.
        </p>
