...
export default function Component() {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Regression Band</CardTitle>
        <CardDescription>A straight-line fit with its confidence band.</CardDescription>
      </CardHeader>
      <CardContent>
      ...
      <CardFooter className="flex-col items-start gap-2 text-sm">
        <div className="flex gap-2 leading-none font-medium">
          About £0.90 more per extra minute <TrendingUp className="h-4 w-4" />
        </div>
