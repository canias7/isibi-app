...
export default function Component() {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Letter-Value Plot</CardTitle>
        <CardDescription>A box plot that keeps describing the tails.</CardDescription>
      </CardHeader>
      <CardContent>
      ...
      <CardFooter className="flex-col items-start gap-2 text-sm">
        <div className="flex gap-2 leading-none font-medium">
          Colour's tail runs a long way <TrendingUp className="h-4 w-4" />
        </div>
