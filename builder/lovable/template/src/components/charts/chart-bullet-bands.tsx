  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Custom qualitative bands.</CardDescription>
      </CardHeader>
      <CardContent>
        <Bullet label="Bookings" value={268} target={300} max={400} bands={[0.4, 0.7, 1]} />
      </CardContent>
      <CardFooter className="flex-col items-start gap-2 text-sm">
        <div className="flex gap-2 leading-none font-medium">
          In the middle band <TrendingUp className="h-4 w-4" />
        </div>
