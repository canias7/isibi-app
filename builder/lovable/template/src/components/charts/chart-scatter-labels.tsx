...
import { CartesianGrid, LabelList, Scatter, ScatterChart, XAxis, YAxis } from "recharts"
    ...
    <Card>
      ...
      <CardContent>
        <ChartContainer config={chartConfig} className="h-[250px] w-full">
          <ScatterChart accessibilityLayer margin={{ left: 8, right: 8, top: 16 }}>
            <CartesianGrid />
            ...
            <Scatter data={chartData} fill="var(--color-bookings)">
              <LabelList dataKey="bookings" position="top" className="fill-foreground" fontSize={11} />
            </Scatter>
          </ScatterChart>
        </ChartContainer>
      </CardContent>
