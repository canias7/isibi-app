  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Ahead of target.</CardDescription>
      </CardHeader>
      <CardContent>
        <Bullet label="Revenue" value={8420} target={7500} max={10000} format={(n) => "£" + n.toLocaleString()} />
      </CardContent>
      <CardFooter className="flex-col items-start gap-2 text-sm">
        <div className="flex gap-2 leading-none font-medium">
          12% ahead <TrendingUp className="h-4 w-4" />
        </div>
