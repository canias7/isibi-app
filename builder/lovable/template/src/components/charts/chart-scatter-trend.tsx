      ...
      <CardContent>
        <ChartContainer config={chartConfig} className="h-[250px] w-full">
          <ScatterChart accessibilityLayer margin={{ left: 8, right: 8 }}>
            <CartesianGrid />
            <XAxis dataKey="spend" type="number" domain={[0, 70]} tickLine={false} axisLine={false} />
            <YAxis dataKey="bookings" type="number" tickLine={false} axisLine={false} />
            <ReferenceLine segment={[{ x: 10, y: 26 }, { x: 62, y: 128 }]} stroke="var(--color-reach)" strokeDasharray="4 4" />
