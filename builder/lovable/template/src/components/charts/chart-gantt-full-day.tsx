  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>With an hour either side of opening.</CardDescription>
      </CardHeader>
      <CardContent>
        <Gantt tasks={tasks} ticks={ticks} min={-1} max={9} today={4} />
      </CardContent>
      <CardFooter className="flex-col items-start gap-2 text-sm">
        <div className="flex gap-2 leading-none font-medium">
          Nothing booked before 9 <TrendingUp className="h-4 w-4" />
        </div>
