...
export default function Component() {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Raincloud</CardTitle>
        <CardDescription>Shape, summary and every point at once.</CardDescription>
      </CardHeader>
      <CardContent>
      ...
      <CardFooter className="flex-col items-start gap-2 text-sm">
        <div className="flex gap-2 leading-none font-medium">
          Colour is wide and lumpy <TrendingUp className="h-4 w-4" />
        </div>
