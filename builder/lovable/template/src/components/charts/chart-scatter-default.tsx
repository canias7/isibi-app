      ...
      <CardContent>
        <ChartContainer config={chartConfig} className="h-[250px] w-full">
          <ScatterChart accessibilityLayer margin={{ left: 8, right: 8 }}>
            <CartesianGrid />
            <XAxis dataKey="spend" type="number" name="Spend" tickLine={false} axisLine={false} />
            <YAxis dataKey="bookings" type="number" name="Bookings" tickLine={false} axisLine={false} />
