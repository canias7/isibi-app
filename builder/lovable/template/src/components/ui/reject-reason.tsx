  ...
  return (
    <form className={cn("space-y-3", className)}
      ...
      <div className="space-y-1.5">
        <label htmlFor="reject-reason" className="block text-sm font-medium">{label}</label>
        {reasons.length > 0 && (
        ...
        <textarea id="reject-reason" required rows={3} value={text} onChange={(e) => setText(e.target.value)}
