...
export function CountBadge({ count, max = 99, label, className }: {
  ...
  return (
    <span className={cn("inline-grid h-5 min-w-5 place-items-center rounded-full bg-foreground px-1.5 text-[11px] font-medium tabular-nums text-background", className)}
