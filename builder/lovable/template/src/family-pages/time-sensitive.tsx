  ...
  return (
    <SiteChrome name="The Playhouse" tagline="Box office, but honest about the clock.">
      <div className="mx-auto max-w-2xl px-6 py-12">
        ...
        <div className="mt-10"><CtaBand title="General sale opens at noon" description="Members are in now. Everyone else, set an alarm — last season sold out by two." action={{ label: "Buy now", href: "#top" }} /></div>
      </div>
    </SiteChrome>
  );
}
