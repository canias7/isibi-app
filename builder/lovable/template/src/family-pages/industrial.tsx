...
function P() {
  ...
  return (
    <SiteChrome name="Attercliffe Fastenings" tagline="Cold-forged fasteners since 1953. BS EN ISO 898-1."
      links={[{ label: "Specs", href: "#specs" }, { label: "Downloads", href: "#dl" }]}
      ...
      <div className="mx-auto max-w-3xl px-6 py-12">
        ...
        <section id="specs" className="mt-8 rounded-xl border">
          ...
          <SpecRow label="Property classes" value="8.8 · 10.9 · 12.9" highlight />
        ...
        <section id="quote" className="mt-10">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Sizes, grades, quantities — paste your schedule straight in.</p>
