  ...
  return (
    <SiteChrome name="Hale & Frost" tagline="Weddings photographed like they felt."
      ...
      <div className="mx-auto max-w-5xl px-6 pb-16">
        ...
        <p className="mt-2 text-center text-sm"><a className="underline underline-offset-4" href="#/project">See one whole day told properly →</a></p>
        ...
        <div id="enquire" className="mt-16">
          <CtaBand title="2027 has nine weekends left" description="Tell us the date and the place. We answer within a day." action={{ label: "Start a project", href: "#/contact" }} />
        </div>
      </div>
    </SiteChrome>
  );
