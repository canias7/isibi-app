    ...
    <SiteChrome name="Loxley Lets" tagline="Rentals across the west of the city."
      ...
      <div className="mx-auto max-w-5xl px-6 py-10">
        ...
        <div id="results" className="mt-6 grid gap-5 sm:grid-cols-2">
          <PropertyCard price="£925 pcm" address="Flat 2, 14 Commonside, Walkley" beds={2} baths={1} area="61 m²" status="New this week" href="#results" image={null} />
          <PropertyCard price="£1,150 pcm" address="7 Greenhow Street, Crookes" beds={3} baths={1} area="84 m²" href="#results" image={null} />
          <PropertyCard price="£795 pcm" address="Flat 5, Loxley Court, Malin Bridge" beds={1} baths={1} area="48 m²" href="#results" image={null} />
          <PropertyCard price="£1,400 pcm" address="22 Den Bank Crescent, Crosspool" beds={4} baths={2} area="112 m²" status="Garden" href="#results" image={null} />
        </div>
      </div>
    </SiteChrome>
  );
