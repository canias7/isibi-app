    ...
    <SiteChrome name="Kelham Works" tagline="A 14-person product studio by the river."
      ...
      <div className="mx-auto max-w-3xl px-6 py-12">
        ...
        <div id="roles" className="mt-4 grid gap-4">
          <JobCard title="Senior product designer" team="Design" location="Kelham Island · hybrid" type="Full time" salary="£55–65k" postedAt="2026-07-24" href="#roles" tags={["Figma", "Design systems"]} />
          <JobCard title="TypeScript engineer" team="Build" location="Remote UK" type="Full time" salary="£60–72k" postedAt="2026-07-28" href="#roles" tags={["React", "Node"]} />
          <JobCard title="Studio coordinator" team="Ops" location="Kelham Island" type="4 days" salary="£28–32k pro rata" postedAt="2026-07-30" href="#roles" />
        </div>
