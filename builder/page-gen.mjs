...
export const UI_COMPONENTS = [
  ...
  "admission-prices", "entry-requirements", "facility-status", "fare-quote",
  "inspection-rating", "produce-calendar", "quote-calculator",
  ...
  "tap-list", "triage-banner", "unit-card", "vehicle-lookup",
];
