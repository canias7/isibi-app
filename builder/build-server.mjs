...
// The transport under every model call made in this container — `node:https`,
// never Node’s fetch, whose 300-second headers timeout is not a knob. It moved
// to its own module on 2026-09-14 so the JOB CHILD can use it too; that file’s
// comment carries the whole reason and what it cost not to have it.
