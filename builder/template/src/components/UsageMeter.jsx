...
export function UsageBar({ label, used = 0, cap = 0, unit = '', format, className }) {
  ...
  return (
    <div className={className}>
      ...
      <div className="h-2 w-full overflow-hidden rounded-full bg-ink-100"
        role="progressbar" aria-label={label} aria-valuenow={used} aria-valuemin={0} aria-valuemax={cap || undefined}>
...
export default function UsageMeter({ title = 'Plan usage', plan, renews, metrics = [], upgradeTo, upgradeLabel = 'Upgrade plan', className }) {
