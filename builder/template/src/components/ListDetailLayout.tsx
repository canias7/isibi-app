...
export default function ListDetailLayout({ list, detail, selected = false, listWidth = 'md:w-80', emptyDetail = 'Select an item to see its details.', className }: ListDetailLayoutProps) {
  return (
