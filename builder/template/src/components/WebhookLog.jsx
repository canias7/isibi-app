...
import { METHOD_TONES } from './EndpointRow.jsx'
...
export default function WebhookLog({ entries = [], onRetry, title = 'Recent deliveries', emptyText = 'No deliveries yet.', className }) {
