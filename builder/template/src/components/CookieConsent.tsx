...
export default function CookieConsent({ message = 'We use cookies to keep the site working and understand what people find useful.', policyHref, className }: CookieConsentProps) {
