...
export default function PromoCodeInput({ applied, onApply, onRemove, label = 'Promo code', placeholder = 'Enter a code', className }) {
  ...
  return (
    <form onSubmit={submit} className={className}>
      ...
      <div className="flex gap-2">
        <input id="promo-code" value={code} onChange={(e) => { setCode(e.target.value); setMsg(null) }}
