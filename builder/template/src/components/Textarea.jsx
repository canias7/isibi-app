...
const Textarea = forwardRef(function Textarea(
  { label, hint, error, className, wrapperClassName, id, rows = 4, ...props },
  ref
) {
  const autoId = useId()
  ...
  return (
    <div className={cx('flex flex-col gap-1.5', wrapperClassName)}>
      ...
      <textarea
        ...
        aria-invalid={!!error}
        className={cx(
          'w-full rounded-xl border bg-white px-3.5 py-2.5 text-sm text-ink-900 placeholder:text-ink-400 transition-colors resize-y',
