...
export default function ChatComposer({ onSend, placeholder = 'Write a message…', busy = false, onAttach, className }: ChatComposerProps) {
  ...
  return (
    <div className={cx('flex items-end gap-2 border-t border-ink-100 p-3', className)}>
      ...
      <textarea rows={1} value={text} onChange={(e) => setText((e.target as any).value)} placeholder={placeholder}
