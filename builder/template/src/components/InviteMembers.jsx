      ...
      <div className="mt-4 space-y-2">
        {rows.map((row, i) => (
          <div key={i} className="flex gap-2">
            <input type="email" value={row.email} onChange={(e) => set(i, { email: e.target.value })}
            ...
            <select value={row.role} onChange={(e) => set(i, { role: e.target.value })} aria-label={`Role for invite ${i + 1}`}
