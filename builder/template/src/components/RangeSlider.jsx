  ...
  return (
    <div className={className}>
      ...
      <div className="relative h-5">
        ...
        <input type="range" min={min} max={max} step={step} value={lo} onChange={(e) => setLo(e.target.value)}
          aria-label={label ? `${label} minimum` : 'Minimum'} className={thumb} />
        <input type="range" min={min} max={max} step={step} value={hi} onChange={(e) => setHi(e.target.value)}
