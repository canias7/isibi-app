...
type CurrencyInputProps = Omit<React.ComponentPropsWithoutRef<'div'>, 'onChange'> & {
  label?: ReactNode
  value?: any
    ...
    <div className={cx('flex flex-col gap-1.5', wrapperClassName)}>
      ...
      <div className="relative">
        ...
        <input id={fieldId} type="number" inputMode="decimal" min={min} step={step} placeholder={placeholder}
          value={value} onChange={(e) => onChange && onChange((e.target as any).value)} aria-invalid={!!error}
