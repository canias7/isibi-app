...
export default function CopyButton({ value, label = 'Copy', copiedLabel = 'Copied', className }) {
  ...
  return (
    <button type="button" onClick={copy}
      className={cx('inline-flex items-center gap-1.5 rounded-lg border border-ink-200 bg-surface px-2.5 py-1.5 text-xs font-medium text-ink-600 transition hover:bg-ink-50',
