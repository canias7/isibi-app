...
export function Sparkline({ data = [], width = 160, height = 40, className }) {
...
export function LineChart({ data = [], height = 180, className }) {
  if (!data.length) return null
  const w = 100, h = 100
...
export function BarChart({ items = [], height = 180, className }) {
...
export function DonutChart({ segments = [], size = 140, thickness = 16, center, className }) {
