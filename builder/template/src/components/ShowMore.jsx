...
export default function ShowMore({ children, lines, collapsedHeight = 160, more = 'Show more', less = 'Show less', className }) {
  const [open, setOpen] = useState(false)
  // Line clamping is cleaner when you know the line count; height clamping handles mixed content (lists, images).
  const clamp = lines ? { WebkitLineClamp: lines, display: '-webkit-box', WebkitBoxOrient: 'vertical', overflow: 'hidden' }
