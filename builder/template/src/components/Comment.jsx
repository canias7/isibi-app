...
export function Comment({ author, avatar, time, body, actions, rating, children, className }) {
  return (
...
export default function CommentList({ comments = [], renderComment, empty = 'No comments yet — be the first.', className }) {
