...
export const BACKEND_RULES =
  ...
  "Build REAL, working flows — a contact form that truly saves, a login that truly works, a dashboard that shows the signed-in visitor's own rows, a real file upload. Guard every fetch in try/catch and show a friendly error/success state. Do NOT invent other backend endpoints — these are the only ones. ";
