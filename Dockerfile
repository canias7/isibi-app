...
# build server to check a launch before it spawns the runner; `job-clock.mjs`
# (2026-09-06, stage 5d) is the child's deadline and the two-signal stop the
# service arms per child — dependency-free, so this line stays one file.
COPY builder/build-server.mjs builder/build-keys.mjs builder/build-call.mjs builder/gen-code.mjs builder/model-fanout.mjs builder/model-xai.mjs builder/exit-reason.mjs builder/run-step.mjs builder/site-ssr.mjs builder/render-server-child.mjs builder/site-addon.mjs builder/site-fonts.mjs builder/font-index.json builder/site-theme.mjs builder/site-theme-registry.mjs builder/site-seeds.mjs builder/site-tokens.mjs builder/site-css.mjs builder/site-freecss.mjs builder/site-authored.mjs builder/site-style.mjs builder/site-identity.mjs builder/site-mark.mjs builder/site-favicon.mjs builder/site-qr-list.mjs builder/site-card.mjs builder/site-langs.mjs builder/render-check.mjs builder/site-render.mjs builder/site-worker.mjs builder/container-job.mjs builder/container-env.mjs builder/job-gateway.mjs builder/job-clock.mjs builder/kit-closure.mjs builder/long-post.mjs builder/job-probe.mjs builder/job-duration.mjs ./
